                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-default" title="文件上传" onclick='location.href="${ctx}/store/question?operation=toTestFileUpload"'><i class="fa fa-file-o"></i> 文件上传</button>
